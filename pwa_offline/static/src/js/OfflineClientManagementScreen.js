odoo.define('pwa_offline.OfflineClientManagementScreen', function (require) {
	'use strict';
	...
	class OfflineClientManagementScreen extends PosComponent {
		constructor() {
			super(...arguments);
			this.state = {
				query: null,
	...
	OfflineClientManagementScreen.template = 'OfflineClientManagementScreen';
	OfflineClientManagementScreen.hideOrderSelector = true;
	Registries.Component.add(OfflineClientManagementScreen);
	return OfflineClientManagementScreen;
});
